...
function RevealHeading({ children, className = "" }: { children: string; className?: string }) {
  ...
  return (
    <span className={`reveal-text flex flex-wrap justify-center gap-x-[0.35em] gap-y-[0.15em] ${className}`}>
      {words.map((word, idx) => (
        <span key={idx} className="reveal-text-line inline-block overflow-hidden pb-2 pr-2 -mb-2 -mr-2">
          <span
      ...
      <main className="flex-grow flex flex-col items-center justify-start pt-20 pb-8 px-6 relative">
          ...
          {isSubmitted ? (
            <div className="text-center py-16 space-y-4 animate-fade-in flex flex-col items-center">
              <div className="relative mb-6">
                ...
                <div className="absolute inset-0 bg-[#02029c] rounded-full scale-110 opacity-20 blur-sm rotate-45"></div>
                <div className="relative w-24 h-24 bg-[#02029c] rounded-full flex items-center justify-center shadow-lg border-4 border-white">
            ...
            <div className="max-w-2xl mx-auto w-full space-y-8">
              <div className="space-y-2">
                <p className="font-sans text-sm sm:text-base text-black leading-relaxed font-normal text-center">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-white border border-black/20 px-4 py-3 text-sm text-[#000000] placeholder:text-slate-400 focus:outline-none focus:border-[#02029c] transition-all duration-300 font-sans rounded-[1px]"
                ...
                <div>
                  ...
                  <div className="flex w-full">
                    <select
                      ...
                      className="bg-gray-50 border border-r-0 border-black/20 px-3 py-3 text-sm text-[#000000] focus:outline-none focus:border-[#02029c] transition-all duration-300 font-sans rounded-l-[1px] w-[120px] cursor-pointer"
                    >
                    ...
                    <input
                      ...
                      className="flex-1 w-full bg-white border border-black/20 px-4 py-3 text-sm text-[#000000] placeholder:text-slate-400 focus:outline-none focus:border-[#02029c] transition-all duration-300 font-sans rounded-r-[1px]"
                    ...
                    {(['Consulting', 'Legal', 'Both'] as const).map((opt) => (
                      <button
                        ...
                        className={`px-6 py-2.5 rounded-full text-xs font-bold tracking-wider uppercase transition-all duration-300 border ${
                          serviceInterest === opt
                            ? 'bg-[#02029c] border-[#02029c] text-white shadow-sm'
                            : 'bg-white border-black/20 text-[#000000] hover:border-[#02029c] hover:text-[#02029c]'
                        }`}
                      >
                        {opt}
                      </button>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-white border border-black/20 px-4 py-3 text-sm text-[#000000] placeholder:text-slate-400 focus:outline-none focus:border-[#02029c] transition-all duration-300 font-sans resize-none rounded-[1px]"
                ...
                <div className="flex items-start gap-3 mt-4 mb-6">
                  <input
                    ...
                    className="mt-1 w-4 h-4 text-[#02029c] border-black/20 rounded focus:ring-[#02029c] cursor-pointer"
                  />
                  <label htmlFor="terms" className="font-sans text-sm text-black/95 leading-relaxed">
                    I agree to the{' '}
                    <a href="/terms-of-use" className="text-black underline hover:text-[#02029c] transition-colors duration-300">
                      terms of use
                    </a>
                    {' '}and{' '}
                    <a href="/privacy-policy" className="text-black underline hover:text-[#02029c] transition-colors duration-300">
                      privacy policy
                    </a>.
                  </label>
                </div>
                ...
                <div className="flex justify-center pt-2">
                  <button
                    type="submit"
                    disabled={isLoading}
                    className="w-full sm:w-auto px-16 bg-[#02029c] hover:bg-[#1915e1] disabled:bg-[#02029c]/50 text-white text-xs font-bold tracking-[0.2em] uppercase py-4 transition-all duration-300 rounded-[1px] shadow-md flex items-center justify-center gap-2"
                  >
                    {isLoading ? (
                      <>
        ...
        <div className="w-full max-w-5xl mt-16 mb-0 z-10 flex flex-col items-center px-4">
          <div className="flex flex-col items-center mb-10">
            ...
            <svg className="w-48 h-2 mt-2 text-[#02029c]" viewBox="0 0 100 4" fill="currentColor" preserveAspectRatio="none">
