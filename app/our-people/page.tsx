    ...
    <main className="min-h-screen bg-white pb-0">
      ...
      <section className="relative w-full bg-[#fa0249] py-10 md:py-12 px-6 md:px-16 text-center text-black z-20">
        <div className="max-w-4xl mx-auto space-y-6 scroll-fade-up">
          ...
          <div className="font-sans text-sm md:text-base text-black/70 font-light max-w-2xl mx-auto leading-relaxed space-y-2">
            <p>Establish a direct partner relationship or initiate a mandate.</p>
            <p>Our strategy and legal practices operate under strict NDA protocols.</p>
          </div>
          <div className="pt-4">
            <Link
              href="/contact-us"
