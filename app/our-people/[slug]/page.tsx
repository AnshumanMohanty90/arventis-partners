    ...
    <div className="relative w-full overflow-hidden bg-black text-white min-h-screen">
      ...
      <section className="relative w-full bg-[#000000] pt-28 pb-12 md:pt-36 md:pb-16 px-6 md:px-16">
        <div className="max-w-7xl mx-auto relative z-10 space-y-6">
          ...
          <div>
            <Link
              href="/our-people"
              className="inline-flex items-center gap-2 bg-white/5 hover:bg-[#02029c] hover:text-black text-white text-xs tracking-[0.2em] font-bold uppercase border border-white/10 px-5 py-3 transition-all duration-300 hover-target shadow-md"
            >
          ...
          <div className="pt-4">
            ...
            <p className="font-sans text-xs sm:text-sm md:text-base text-[#02029c]/90 font-medium tracking-wider uppercase mt-2">
              {person.title}
            </p>
          </div>
        </div>
      ...
      <section className="relative w-full bg-white py-12 md:py-16 px-6 md:px-16 text-black">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-8 space-y-10">
            ...
            {/* Credentials Banner */}
            {person.credentials && (
              <div className="bg-white p-6 border-l-4 border-[#02029c] shadow-md">
            ...
            <div className="space-y-4 bg-white p-8 sm:p-10 border border-black/10 shadow-md">
              ...
              <div className="space-y-4 font-sans text-xs sm:text-sm md:text-base text-black leading-relaxed font-normal">
            ...
            {person.customSectionTitle && person.customSectionContent && (
              <div className="bg-[#000000] text-white p-8 sm:p-10 border border-[#02029c]/30 shadow-2xl space-y-6">
                <div className="flex items-center gap-3">
                  <div className="w-2.5 h-2.5 bg-[#02029c]" />
                  <h3 className="font-serif text-2xl sm:text-3xl font-light tracking-wide text-white">
                    {person.customSectionTitle}
                  </h3>
                </div>
                <div className="space-y-4 font-sans text-xs sm:text-sm md:text-base text-white/95 leading-relaxed font-normal">
            ...
            {person.clientList && person.clientList.length > 0 && (
              <div className="bg-white p-8 sm:p-10 border border-black/10 shadow-md space-y-4">
                <h3 className="font-serif text-xl sm:text-2xl font-light text-black tracking-wide border-b border-black/10 pb-3">
                  Key Institutional Clients and Representative Mandates
                </h3>
                <div className="flex flex-wrap gap-2.5 pt-2">
                  {person.clientList.map((client, idx) => (
                    ...
                    >
                      <Building2 size={13} className="text-[#02029c]" />
                      <span>{client}</span>
                    </span>
                  ))}
                </div>
            ...
            {person.highlights && person.highlights.length > 0 && (
              <div className="bg-white p-8 sm:p-10 border border-black/10 shadow-md space-y-4">
                <h3 className="font-serif text-xl sm:text-2xl font-light text-black tracking-wide border-b border-black/10 pb-3">
                  Key Practice Highlights and Representative Experience
                </h3>
                <div className="space-y-3 pt-2">
                  {person.highlights.map((item, idx) => (
                    <div key={item.id || idx} className="flex items-start gap-3 bg-white p-4 border border-black/5">
                      <span className="w-2 h-2 rounded-full bg-[#02029c] mt-2 flex-shrink-0" />
            ...
            <div className="bg-[#000000] text-white p-8 sm:p-10 border border-[#02029c]/30 shadow-2xl space-y-6">
              <div>
                <span className="font-sans text-[10px] tracking-[0.3em] uppercase text-[#02029c] font-bold block mb-1">
              ...
              <p className="font-sans text-xs sm:text-sm text-white/90 font-normal leading-relaxed max-w-2xl">
              ...
              <div className="pt-2 flex flex-wrap items-center gap-4">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-3 bg-white/10 hover:bg-[#02029c] text-white hover:text-white font-sans text-xs font-bold tracking-[0.2em] uppercase px-6 py-3.5 border border-white/20 transition-all duration-300 shadow-md hover-target"
                >
      ...
      <section className="relative w-full bg-black py-10 md:py-12 px-6 md:px-16 text-center text-white z-20">
        <div className="max-w-4xl mx-auto space-y-6 scroll-fade-up">
          ...
          <p className="font-sans text-sm md:text-base text-white/90 font-normal max-w-2xl mx-auto leading-relaxed">
            Establish a direct partner relationship, or initiate a new mandate. Both practices operate under standard NDA protocols.
          </p>
          <div className="pt-4">
            <Link
              href="/contact-us"
              className="inline-block bg-[#02029c] hover:bg-[#1915e1] text-white font-bold text-xs tracking-[0.2em] uppercase px-10 py-4 transition-all duration-300 hover-target shadow-xl rounded-[1px]"
            >
              CONTACT US
            </Link>
          </div>
