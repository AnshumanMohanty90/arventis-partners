...
const consultingServices = [
  {
    ...
    description: [
      "We help management teams build growth strategy on evidence rather than assumption, using market sizing, segmentation, and whitespace mapping to establish where a business has a genuine right to win and where it does not. <br className=\"hidden lg:block\"/>This includes a candid assessment of competitive position, cost structure, and the capabilities required to defend or expand it.",
  ...
  },
  {
    ...
    description: [
      "We support businesses entering new markets, including India, Saudi Arabia, the UAE, Kuwait, and South Korea, drawing on direct operating experience across each of these markets rather than advisory observation from outside them. <br className=\"hidden lg:block\"/>Our work begins with regulatory assessment and compliance-aware commercial planning, since entry structure, licensing requirements, and permissible ownership models vary substantially by geography and sector.",
      "From there, we define the target segment and ideal customer profile, evaluate direct, partner-led, institutional, and D2C channel options, and structure commercial terms with the channel partners best positioned to carry the business into the market. <br className=\"hidden lg:block\"/>Pricing and positioning are localised to the competitive dynamics of that specific market rather than adapted from a template built for the home market."
    ]
  },
  {
    num: '03',
  ...
  },
  {
    ...
    description: [
      "We identify the sources of process inefficiency that are not visible until they affect cost, customer experience, or compliance standing, typically because the process as documented differs materially from the process as actually run. <br className=\"hidden lg:block\"/>Our approach begins with mapping the process as it currently operates, including the informal workarounds staff have built to compensate for gaps in the formal design, before redesigning service delivery and the customer journey around it.",
  ...
  },
  {
    ...
    description: [
      "We build the senior relationship architecture and expansion frameworks required to grow a major account beyond its initial scope, on the premise that winning an account is the beginning of the commercial relationship rather than its conclusion. <br className=\"hidden lg:block\"/>This includes structured account farming, refined value propositions tailored to each stakeholder within the account, and early identification of adjacent mandates before a competitor identifies them first.",
      ...
      <section className="relative w-full min-h-[60vh] md:min-h-[75vh] flex flex-col justify-between pb-16 md:pb-24 px-6 md:px-16 border-b border-white/10 text-white overflow-hidden pt-28 bg-black">
        ...
        <div className="max-w-7xl mx-auto w-full relative z-20 mt-auto pt-16">
          ...
          <p className="scroll-fade-up font-sans text-base sm:text-lg md:text-xl text-white/90 font-normal leading-relaxed max-w-3xl transition-delay-300 drop-shadow-md">
            ...
            <br className="hidden md:block" />delivered across India, the GCC, and international jurisdictions.
          </p>
        </div>
      </section>
