        ...
        <article className="max-w-[800px] w-full text-[#10141A]">
          ...
          <div className="space-y-12">
            <section>
              ...
              <ul className="font-sans text-base md:text-lg leading-[1.8] list-disc pl-5 space-y-3 marker:text-[#16284C]">
            ...
            <section>
              ...
              <ul className="font-sans text-base md:text-lg leading-[1.8] list-disc pl-5 space-y-2 marker:text-[#16284C] mb-4">
