...
const ContactUs = () => {
  return (
   <>
      <section className="relative w-full bg-[#16284C] py-6 md:py-8 px-6 md:px-16 text-center text-black z-20">
         <div className="max-w-4xl mx-auto space-y-4 scroll-fade-up">
           ...
           <div className="pt-2">
             <Link
               href="/contact-us"
               className="inline-block bg-white hover:bg-[#16284C] hover:border hover:border-white text-black hover:text-white font-bold text-xs  tracking-[0.2em] uppercase px-10 py-3.5 transition-all duration-300 hover-target shadow-xl rounded-[1px]"
             >
               CONTACT US
             </Link>
           </div>
