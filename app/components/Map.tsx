  ...
  return (
    <div ref={mapContainer} className="absolute inset-0 z-0">
      <style dangerouslySetInnerHTML={{
        ...
        .marker-pin { width: 12px; height: 12px; border-radius: 50%; background: #02029c; border: 2px solid white; box-shadow: 0 0 0 4px rgba(252, 190, 3, 0.4), 0 0 10px rgba(252, 190, 3, 0.8); animation: pulse 2s infinite; }
