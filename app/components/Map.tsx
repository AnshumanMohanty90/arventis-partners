  ...
  return (
    <div ref={mapContainer} className="absolute inset-0 z-0">
      <style dangerouslySetInnerHTML={{
        ...
        .marker-pin { width: 12px; height: 12px; border-radius: 50%; background: #fa0249; border: 2px solid white; box-shadow: 0 0 0 4px rgba(250, 2, 73, 0.4), 0 0 10px rgba(250, 2, 73, 0.8); animation: pulse 2s infinite; }
        @keyframes pulse { 0% { box-shadow: 0 0 0 0px rgba(250, 2, 73, 0.7), 0 0 10px rgba(250, 2, 73, 0.8); } 70% { box-shadow: 0 0 0 10px rgba(250, 2, 73, 0), 0 0 10px rgba(250, 2, 73, 0.8); } 100% { box-shadow: 0 0 0 0px rgba(250, 2, 73, 0), 0 0 10px rgba(250, 2, 73, 0.8); } }
