    ...
    <div className="relative w-full overflow-hidden bg-white text-black min-h-screen font-sans">
      ...
      <section className="relative w-full py-20 px-6 md:px-16 text-black">
        <div className="max-w-5xl mx-auto space-y-12">
          ...
          {/* Highlight Card */}
          <div className="scroll-fade-up p-8 bg-white border border-black/10 border-l-4 border-l-[#02029c] shadow-md rounded-[1px] space-y-3">
            <div className="flex items-center gap-3 text-black">
              <ShieldAlert className="w-5 h-5 text-[#02029c] flex-shrink-0" />
              <h3 className="font-serif text-xl font-semibold">Bar Council Compliance Notice</h3>
            </div>
            <p className="font-sans text-xs sm:text-sm text-black/95 leading-relaxed font-normal">
          ...
          <div className="scroll-fade-up bg-white p-8 md:p-10 border border-black/10 shadow-sm space-y-4">
            <h3 className="font-serif text-2xl font-light text-black flex items-center gap-3">
              <Scale className="w-5 h-5 text-[#02029c]" />
              <span>1. Purpose of Information and Non-Solicitation</span>
            </h3>
            <div className="space-y-3 font-sans text-xs sm:text-sm text-black/95 leading-relaxed font-normal">
              <p>
          ...
          <div className="scroll-fade-up bg-white p-8 md:p-10 border border-black/10 shadow-sm space-y-4">
            <h3 className="font-serif text-2xl font-light text-black flex items-center gap-3">
              <FileText className="w-5 h-5 text-[#02029c]" />
          ...
          <div className="scroll-fade-up bg-white p-8 md:p-10 border border-black/10 shadow-sm space-y-4">
            <h3 className="font-serif text-2xl font-light text-black flex items-center gap-3">
              <CheckCircle2 className="w-5 h-5 text-[#02029c]" />
            ...
            <div className="space-y-3 font-sans text-xs sm:text-sm text-black/95 leading-relaxed font-normal">
              ...
              <div className="pt-4 flex justify-center">
                <Link
                  href="/contact-us"
                  className="inline-flex items-center gap-2 bg-[#02029c] text-white text-xs font-bold tracking-[0.2em] uppercase px-8 py-3.5 transition-colors duration-300 shadow-md"
                >
